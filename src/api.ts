...
const configuredApiBase = ((import.meta as any).env?.VITE_API_BASE_URL as string) || '';
const API_BASE_URL = (configuredApiBase || ((import.meta as any).env?.PROD ? 'https://whats.alattab.site' : '')).replace(/\/$/, '');
